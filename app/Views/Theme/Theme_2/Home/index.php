                    ...
                    <div class="deal-box border position-relative  h-100 me-md-3 mo-m-r-0">
                        <div class="title bg-custom-color text-white d-flex justify-content-between ">
                            ...
                            <span class="icon-mt">
                                ...
                                <svg class="hotdeal-button-next" xmlns="http://www.w3.org/2000/svg" width="8"
                                     height="12" viewBox="0 0 8 12" fill="none">
                        ...
                        <div id="hotPro" class="swiper hotpro mo-text-center">
                            <div class="hotpro-nav position-absolute top-50 w-100" style="z-index:99">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     class="hotpro-button-prev left-arr float-start ms-2" width="8" height="12"
                                     viewBox="0 0 8 12" fill="none">
                                    <path d="M6 12L0 6L6 0L7.4 1.4L2.8 6L7.4 10.6L6 12Z" fill="#000000"/>
                                </svg>
                                <svg class="hotpro-button-next float-end me-2" xmlns="http://www.w3.org/2000/svg"
...
<path d="M6 12L0 6L6 0L7.4 1.4L2.8 6L7.4 10.6L6 12Z" fill="#FFFBFB"/>
                                ...
                                <svg class="trend-button-next" xmlns="http://www.w3.org/2000/svg" width="8" height="12"
                                     viewBox="0 0 8 12" fill="none">
<path d="M1.4 12L0 10.6L4.6 6L0 1.4L1.4 0L7.4 6L1.4 12Z" fill="#FFFBFB"/>
</svg>
                                    </span>
                ...
                <div class="col-md-9 col-12">
                    <div class="video h-100">
                        <iframe class="h-100 w-100"
                                src="<?php echo get_lebel_by_value_in_theme_settings('trending_youtube_video'); ?>"
                                title="My sunconure flock flewed high in sky for more then 5min||sunconure freefly training in india||"
                                frameborder="0"
                    ...
                    <div class="deal-box border position-relative  h-100 me-md-3 mo-m-r-0">
                        ...
                        <div class="products h-100 p-2 mo-text-center">
                            <?php foreach ($specialPro as $pro) { ?>
                                <div class="row border-top mt-3 pt-1 pb-1"
                                     style="margin-left: -8px !important;margin-right: -8px !important;margin-top: -8px !important;">
                        ...
                        <div class="products mt-5 ">
                            ...
                            <div class="menu d-flex justify-content-between ">
                                <div class="nav nav-tabs border-0 special-tab" id="nav-tab" role="tablist">
                                    <a class="btn border rounded-0 btn-sp-m nav-link active "
                                       onclick="loadFun('regular')" data-bs-toggle="tab" href="#nav-home" role="tab"
                                       aria-controls="nav-home"
                                       aria-selected="true"><?php echo $special_category_one_name; ?></a>
                                    <a class="btn border rounded-0 btn-sp-m nav-link" onclick="loadFun('regular-2')"
                                       data-bs-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile"
                                       aria-selected="false"><?php echo $special_category_two_name; ?></a>
                                    <a class="btn border rounded-0 btn-sp-m nav-link" onclick="loadFun('regular-3')"
                                       data-bs-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact"
                                       aria-selected="false"><?php echo $special_category_three_name; ?></a>
                                </div>
                                <div class="menu-icon ">
                                </div>
                            </div>
                    ...
                    <div class="products h-100">
                        <div id="etcPro" class="swiper etcpro mo-text-center h-100">
                            <div class="etcpro-nav position-absolute top-50 w-100" style="z-index:99">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     class="etcpro-button-prev left-arr float-start ms-2" width="8" height="12"
                                     viewBox="0 0 8 12" fill="none">
                                    <path d="M6 12L0 6L6 0L7.4 1.4L2.8 6L7.4 10.6L6 12Z" fill="#000000"/>
                                </svg>
                                <svg class="etcpro-button-next float-end me-2" xmlns="http://www.w3.org/2000/svg"
                                     width="8" height="12" viewBox="0 0 8 12" fill="none">
                                    <path d="M1.4 12L0 10.6L4.6 6L0 1.4L1.4 0L7.4 6L1.4 12Z" fill="#000000"/>
                                </svg>
                            </div>
        ...
        <div class="weekly-deals marg-top-90 Brand mb-5">
            <div class="row gx-0">
                        ...
                        <div class="title  bg-custom-color text-white d-flex justify-content-between ">
                            ...
                            <span class="icon-mt brand-nav">
                                ...
                                <span data-bs-target="#brand" data-bs-slide="prev">
                                    <svg class="left-arr carousel-control-prev ar-prev" xmlns="http://www.w3.org/2000/svg"
                                         width="8" height="12" viewBox="0 0 8 12" fill="none">
                                    <path d="M6 12L0 6L6 0L7.4 1.4L2.8 6L7.4 10.6L6 12Z" fill="#FFFBFB"/>
                                    </svg>
                                </span>
                                ...
                                <span data-bs-target="#brand" data-bs-slide="next">
                                        <svg class="carousel-control-next ar-next" xmlns="http://www.w3.org/2000/svg" width="8"
                                             height="12" viewBox="0 0 8 12" fill="none">
                                    <path d="M1.4 12L0 10.6L4.6 6L0 1.4L1.4 0L7.4 6L1.4 12Z" fill="#FFFBFB"/>
                                    </svg>
                                </span>
                        ...
                        <div class="search">
                            <div class=" p-2 my-1">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="brand" class="form-control border-0"
                ...
                <div class="col-md-9 col-12">
                    <div class="video h-100">
                        <iframe class="h-100 w-100" style="min-height:370px;"
                                src="<?php echo get_lebel_by_value_in_theme_settings('brands_youtube_video'); ?>"
                                title="My sunconure flock flewed high in sky for more then 5min||sunconure freefly training in india||"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        ...
                        <div class="title  bg-custom-color text-white d-flex justify-content-between ">
                            ...
                            <span class="icon-mt">
                                        <svg class="popcat-button-prev left-arr" xmlns="http://www.w3.org/2000/svg"
                                             width="8" height="12" viewBox="0 0 8 12" fill="none"
                                             data-bs-target="#popu-cat" data-bs-slide="prev">
<path d="M6 12L0 6L6 0L7.4 1.4L2.8 6L7.4 10.6L6 12Z" fill="#FFFBFB"/>
</svg>
                                        <svg class="popcat-button-next" xmlns="http://www.w3.org/2000/svg" width="8"
                                             height="12" viewBox="0 0 8 12" fill="none">
<path d="M1.4 12L0 10.6L4.6 6L0 1.4L1.4 0L7.4 6L1.4 12Z" fill="#FFFBFB"/>
</svg>
                                    </span>
                            ...
                            foreach ($populerCat as $catPop) {
                                ...
                                <div class="col p-2 p-md-3 border position-relative">
                                    <a href="<?php echo base_url('category/' . $catPop->prod_cat_id); ?>">
                                        ...
                                        <!--                                        </svg>-->
                                        <h5 class="mt-2 mt-md-4 cat-name"><a
                                                    href="#"><?php echo get_data_by_id('category_name', 'cc_product_category', 'prod_cat_id', $catPop->prod_cat_id); ?></a>
                                        </h5>
                                    </a>
                                </div>
                            <?php } ?>
