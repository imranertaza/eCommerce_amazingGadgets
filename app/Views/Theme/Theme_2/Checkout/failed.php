<section class="main-container checkout" id="tableReload">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="<?php echo base_url()?>/assets/img/faild.svg" alt="success">
            </div>
            <div class="col-md-6 text-center align-self-center">
                <div class="message">
                    <img src="<?php echo base_url()?>/assets/img/fail.svg" alt="success">
                    <p class="fale-title">Failed ! </p>
                    <p class="suc-message">Your order has failed</p>
