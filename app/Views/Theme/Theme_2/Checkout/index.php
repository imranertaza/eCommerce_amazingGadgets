        ...
        <form action="<?php echo base_url('checkout_action') ?>" method="post">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="mb-0"><label class="btn bg-black text-white w-100 rounded-0 " ><input type="checkbox" class="btn-check" name="shipping_else" id="shipping_else" onclick="shippingAddress()">
