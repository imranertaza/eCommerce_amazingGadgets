        ...
        <form action="<?php echo base_url('checkout_action') ?>" method="post">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="mb-4"><label class="btn bg-black text-white w-100 rounded-0 " ><input type="checkbox" class="btn-check" name="shipping_else" id="shipping_else" onclick="shippingAddress()">
                ...
                <div class="col-lg-6">
                    <div class="title-checkout">
                        <label class="btn bg-black text-white w-100 rounded-0"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="22" viewBox="0 0 16 22" fill="none">
                    ...
                    <div class="summery ">
                        ...
                        <div class="title-checkout">
                            <label class="btn bg-black text-white w-100 rounded-0">
