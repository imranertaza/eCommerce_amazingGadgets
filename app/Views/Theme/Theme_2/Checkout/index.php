                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <input class="form-control rounded-0" id="fname1" oninput="livename1View(this.value,'namVal')" type="text" name="payment_firstname" id="name" placeholder="First Name" value="<?php echo isset($customer->firstname) ? $customer->firstname : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                <label class="w-100" for="name">Last Name</label>
                                <input class="form-control rounded-0" id="lname1" oninput="livename1View(this.value,'namVal')" type="text" name="payment_lastname" id="payment_lastname" placeholder="Last Name" value="<?php echo isset($customer->lastname) ? $customer->lastname : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                <label class="w-100" for="email">Email</label>
                                <input class="form-control rounded-0" type="email" name="payment_email" id="email" placeholder="Email" value="<?php echo isset($customer->email) ? $customer->email : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                <label class="w-100" for="phone">Phone</label>
                                <input class="form-control rounded-0" oninput="liveTextView(this.value,'phoneVal')" type="number" name="payment_phone" id="payment_phone" placeholder="Phone" value="<?php echo isset($customer->phone) ? $customer->phone : ''; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                ...
                                <input class="form-control rounded-0" type="number" name="payment_postcode" id="payment_postcode" placeholder="Post code" value="<?php echo $post; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                ...
                                <input class="form-control rounded-0" oninput="liveTextView(this.value,'add1Val')" type="text" name="payment_address_1" id="payment_address_1" placeholder="Address line 1" value="<?php echo $add1 ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                <label class="w-100" for="name">Address line 2*</label>
                                <input class="form-control rounded-0" oninput="liveTextView(this.value,'add2Val')" type="text" name="payment_address_2" id="payment_address_2" placeholder="Address line 2" value="<?php echo $add2 ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="shipping_address" class="mt-4" style="display: none;">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    <label class="w-100" for="name">First Name</label>
                                    <input class="form-control rounded-0" id="fname" oninput="livenameView(this.value,'namVal')" type="text" name="shipping_firstname" id="shipping_firstname" placeholder="First Name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    <label class="w-100" for="name">Last Name</label>
                                    <input class="form-control rounded-0" id="lname" oninput="livenameView(this.value,'namVal')" type="text" name="shipping_lastname" id="shipping_lastname" placeholder="Last Name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    <label class="w-100" for="phone">Phone</label>
                                    <input class="form-control rounded-0" oninput="liveTextView(this.value,'phoneVal')" type="number" name="shipping_phone" id="shipping_phone" placeholder="Phone">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input class="form-control rounded-0" type="number" name="shipping_postcode" id="shipping_postcode" placeholder="Shipping postcode">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    <label class="w-100" for="name">Address line 1*</label>
                                    <input class="form-control rounded-0" oninput="liveTextView(this.value,'add1Val')" type="text" name="shipping_address_1" id="shipping_address_1" placeholder="Address line 1">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    <label class="w-100" for="name">Address line 2*</label>
                                    <input class="form-control rounded-0" oninput="liveTextView(this.value,'add2Val')" type="text" name="shipping_address_2" id="shipping_address_2" placeholder="Address line 2">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                        ...
                        <?php foreach (Cart()->contents() as $val) { ?>
                            <div class="list-item d-flex gap-2 mb-2">
                                ...
                                <div class="list-item-qty text-center bg-gray p-1 py-3 rounded-2 align-items-center d-flex flex-column pro-bg-check">
                                    <button type="button" class="btn btn-sm w-100 p-0" onclick="plusItem('<?php echo $val['rowid']; ?>')" id="minus-btn"><i class="fa fa-plus"></i></button>
                                    <input type="text" id="qty_input" name="qty" class="border-0 text-center item_<?php echo $val['rowid']; ?>" value="<?php echo $val['qty']; ?>" min="1" style="width:45px">
                                    <button type="button" class="btn btn-sm w-100 p-0" onclick="minusItem('<?php echo $val['rowid']; ?>')" id="plus-btn"><i class="fa fa-minus"></i></button>

                                    <button class="btn bg-custom-color text-white btn-sm" id="btn_<?php echo $val['rowid']; ?>" style="display:none;" onclick="updateQty('<?php echo $val['rowid']; ?>')">
                                        Update
                                    </button>
                                </div>
                                ...
                                <?php foreach (get_all_data_array('cc_shipping_method') as $ship) {
                                    if ($ship->status == '1') { ?>
                                        <div class="d-flex justify-content-between mt-3">
                                            <div class="form-check"><label class="form-check-label"><input class="form-check-input" type="radio" name="shipping_method" oninput="shippingCharge()" id="shipping_method" value="<?php echo $ship->code; ?>" required>
                    ...
                    <div class="payment-method group-check mb-4 pb-4">
                        <?php foreach (get_all_data_array('cc_payment_method') as $pay) {
                            if ($pay->status == '1') { ?>
                                <div class="d-flex justify-content-between mt-3">
                                    <div class="form-check"><label class="form-check-label"><input class="form-check-input" onclick="instruction_view(this.value,'<?php echo $pay->code; ?>')" type="radio" name="payment_method" id="payment_method" value="<?php echo $pay->payment_method_id; ?>" required>
                    ...
                    <input type="hidden" name="business" value="<?php echo $paypalEmail->value; ?>">
                    <input type="hidden" name="cmd" value="_xclick">
                    <input type="hidden" name="hosted_button_id" value="6RNT8A4HBBJRE">

                    <input type="hidden" name="amount" id="shipping_tot" value="<?php echo $total ?>">
                    <input type="hidden" name="currency_code" value="USD">
                    <input type="hidden" name="return" value="<?php echo base_url('checkout_action')  ?>">
                    <p>
