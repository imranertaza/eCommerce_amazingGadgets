            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Credit Card Settings</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title">Credit Card Settings</h3>
                    </div>
            ...
            <div class="card-body">
                <form action="<?php echo base_url('cash_on_update_action') ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control" required>
                                    ...
                                    <option value="0" <?php echo ($payment->status == '0') ? 'selected' : ''; ?>>Inactive
                                    </option>
                                </select>
                            </div>
                        </div>
