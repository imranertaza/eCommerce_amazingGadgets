        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 d-flex justify-content-end align-items-center">
                    ...
                    <a class="me-3 py-3 pe-3 border-end d-flex" href="#">
                        <span><i class="fa-solid fa-user me-1"></i></span>
                        <span class="d-none d-sm-block">Create an account</span>
                    </a>
                    <a class="btn btn-signin text-white bg-black" href="#"><i class="fa-solid fa-arrow-right-to-bracket me-1"></i> Sign In</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6 col-md-3 order-1 mb-3 mb-md-0">
                    <div class="logo">
                        <img src="assets/img/logo.png" alt="Amazing Gadgets" class="img-fluid">
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mb-3 mb-md-0 order-2 order-md-3 d-flex justify-content-end">
                    <div class="mini-cart d-flex position-relative">
                        <div class="cart-icon rounded-5 align-items-center justify-content-center p-3 me-3">
                            <img src="assets/img/cart.png" alt="" class="img-fluid">
                        </div>
                        <span class="cart-item position-absolute rounded-5 d-flex align-items-center justify-content-center">7</span>
                        <div class="cart-content d-flex flex-column">
                            <span class="w-100">My Cart</span>
                            <span class="total">0.00tk</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-0">
                ...
                <div class="col-xl-9 col-lg-8 col-md-6 col-4 d-flex align-items-center">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                ...
                                <ul class="navbar-nav d-flex justify-content-center">
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="#">Gadgets</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Toy & games</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Fun product</a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="help-center">
                        <a class="d-flex" href="#">
                            <span><img src="assets/img/info.png" alt="" class="img-fluid"></span>
