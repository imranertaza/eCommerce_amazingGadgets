                        ...
                        <div class="products h-100">
                            <div class="row gx-0 row-cols-1 row-cols-sm-2 row-cols-md-4 h-100">
                                <div class="col border p-2">
                                    <div class="product-grid h-100 d-flex align-items-stretch flex-column">
                                ...
                                <div class="col border p-2">
                                    <div class="product-grid h-100 d-flex align-items-stretch flex-column">
                                        ...
                                        <div class="product-bottom mt-auto">
                                            ...
                                            <div class="product-title mb-2">
                                                <a href="#">The Oversized Alpaca Crew</a>
                                            </div>
                                            <div class="price mb-3">$200.00</div>
                                            <a href="#" class="btn btn-cart w-100 rounded-0 mt-3">Add to Cart</a>
                                        </div>
                                ...
                                <div class="col border p-2">
                                    <div class="product-grid h-100 d-flex align-items-stretch flex-column">
                                        ...
                                        <div class="product-bottom mt-auto">
                                            ...
                                            <div class="product-title mb-2">
                                                <a href="#">The High-Ankle Glove Boot In ReKnit</a>
                                            </div>
                                            <div class="price mb-3">$200.00</div>
                                            <a href="#" class="btn btn-cart w-100 rounded-0 mt-3">Add to Cart</a>
                                        </div>
